# client-server-ip-port-socket.httpsresponse.py
'''
...
print("\033c", end="")
print("Viewing the IP addresses and TCP port numbers HTTP")
print("----------------------------------------------------")
...
if ip_selected == "4":
    ...
    print(f"|----------------------------------------------------------------------------------------|")
    print(f"|------------  TCP Header -------------|-------------- HTTP -----------------------------|")
    print(f"|  Source Port  |   Destination Port   |                                                 |")
    print(f"|    {tls_sock.getsockname()[1]:<6}     |      {port} (HTTPS)     | GET / HTTP/1.1\ Host: {url_Entered}")
    print(f"|--------------------------------------|-------------------------------------------------|")
...
print('\nSocket Pair:')
print('------------')
print(f'Client {tls_sock.getsockname()[0]} : {tls_sock.getsockname()[1]}')
print(f'Server {server_ip} : {port} (HTTPS)')
...
if ip_selected == "4":
    ...
    print(f"|----------------------------------------------------------------------------------------|")
    print(f"|------------  TCP Header -------------|-------------- HTTP -----------------------------|")
    print(f"|  Source Port   |   Destination Port  | {response[0:42]}")
    print(f"|   {port} (HTTPS)  |      {tls_sock.getsockname()[1]:<6}         | {response[43:80]}...")
    print(f"|--------------------------------------|-------------------------------------------------|")
...
if "https" in response_string and "Moved Permanently" in response_string:
    print('\nFrom Server: No HTTP, sending you to HTTPS site')
    print('-------------------------------------------------')
else:  
    print('\nFrom Server:')
    print('------------')
