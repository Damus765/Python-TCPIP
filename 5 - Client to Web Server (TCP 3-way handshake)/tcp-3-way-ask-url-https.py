...
TCP_SYN=TCP(sport=my_source_port, dport=443, flags="S", seq=seq)
...
# scapy
TCP_ACK=TCP(sport=my_source_port, dport=443, flags="A", seq=seq, ack=my_ack)
...
TCP_PUSH=TCP(sport=my_source_port, dport=443, flags="PA", seq=seq, ack=my_ack)
